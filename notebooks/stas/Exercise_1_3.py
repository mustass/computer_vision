...
def trainer(model, train_loader, test_loader,trainset,testset, optimizer, device,num_epochs=10 ):
...
def main():
    ...
    trainer(model, train_loader, test_loader,trainset,testset, optimizer, device,epochs)
